...
```
cd existing_repo
git remote add origin https://gitlab.com/dev6982052/bmi_mavenapp.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dev6982052/bmi_mavenapp/-/settings/integrations)
